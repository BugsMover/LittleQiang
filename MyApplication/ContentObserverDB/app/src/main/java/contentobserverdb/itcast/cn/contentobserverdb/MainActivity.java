...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        //新加一个uri路径，参加市string类型的
        uri = Uri.parse("content://monitordata.itcast.cn.myapplication/info");
        ...
        switch (v.getId()){
            ...
            case R.id.btn_select:
                ...
                //遍历结果集中的数据，将每一条遍历的结果储存在一个List的集合中
            ...
            case R.id.btn_updata:
                //将数据库info表中name为itcast的这条记录更改为name是update_itcast
