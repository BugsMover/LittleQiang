...
import boxuegu.com.boxueguproject.view.ExercisesView;
import boxuegu.com.boxueguproject.view.MyInfoView;
...
if(System.currentTimeMillis()-exitTime>2000){
   ...
   exitTime=System.currentTimeMillis();
    ...
    private void clearLoginStatus() {
        ...
        editor.putString("loginUserName","");//清楚登录时的用户
        editor.commit();//提交修改
    }
