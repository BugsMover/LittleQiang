...
import boxuegu.com.boxueguproject.adapter.AdBannerAdapter;
import boxuegu.com.boxueguproject.adapter.CourseAdapter;
import boxuegu.com.boxueguproject.bean.CourseBean;
import boxuegu.com.boxueguproject.utils.AnalysisUtils;
import boxuegu.com.boxueguproject.view.*;
...
public class CourseView {
    ...
    private boxuegu.com.boxueguproject.view.ViewPagerIndicator vpi;//小圆点
    ...
    private void initView() {
       mCurrentView = mInflater.inflate(R.layout.main_view_course, null);
         ...
         vpi=(boxuegu.com.boxueguproject.view.ViewPagerIndicator)mCurrentView.findViewById(R.id.vpi_advert_indicator);//获取广告上的小圆点
